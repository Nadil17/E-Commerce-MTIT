...
echo ""
echo -e "${CYAN}📚 Swagger Docs:${NC}"
echo "  Unified (via gateway)  →  http://localhost:9090/api-docs"
echo "  Product (native)       →  http://localhost:3001/api-docs"
echo "  User (native)          →  http://localhost:3002/api-docs"
echo ""
